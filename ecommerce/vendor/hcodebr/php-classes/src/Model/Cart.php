...
class Cart extends Model{
    ...
    public function getProducts()
    {
        ...
        return Product::checkList(
            ...
            COUNT(*) AS nrqtd, SUM(b.vlprice) AS vtotal  
    ...
    public function getProductsTotals()
    {
        ...
        $results = $sql->select("
            SELECT COUNT(*) as nrqtd, SUM(a.vlprice) AS vlprice, SUM(a.vlwidth) AS vlwidth, SUM(a.vlheight) AS vlheight, SUM(a.vllength) AS vllength, SUM(a.vlweight) as vlweight
            FROM
            tb_products a 
