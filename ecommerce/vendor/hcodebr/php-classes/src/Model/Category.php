...
class Category extends Model{
    ...
    {
        $sql = new Sql();
        $resutls = $sql->select("SELECT * FROM tb_categories WHERE idcategory = :idcategory",
            array(":idcategory"=>$idcategory));
        
        $this->setData($resutls[0]);
    ...
    public function addProduct(Product $product)
    {
        ...
        $sql->query("INSERT INTO tb_productscategories (idcategory,idproduct) VALUES
